...
variable "ubuntu_publisher" { default = "Canonical" }
variable "ubuntu_offer"     { default = "0001-com-ubuntu-server-jammy" }
variable "ubuntu_sku"       { default = "22_04-lts" } # alternatives: 24_04-lts-gen2, 22_04-lts, 22_04-lts-gen2
variable "ubuntu_version"   { default = "latest" }
